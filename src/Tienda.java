...
public class Tienda {
	...
	public ArrayList<Producto> buscarProductoPorCategoria(String categoria) {
	...
	public void modificarNombreProducto(String nombre) {
	...
	public void modificarDescripcionProducto(String nombre) {
		Scanner scanner = new Scanner(System.in);

		for (Producto producto : productos) {
			if (producto.getNombre().equalsIgnoreCase(nombre)) {
				System.out.println("Ingresa la nueva descripción del producto:");
				String nuevaDescripcion = scanner.nextLine();
				producto.setDescripcion(nuevaDescripcion);
				System.out.println("Descripción del producto modificada exitosamente");
				return;
			}
		}
		System.out.println("Producto no encontrado");
	...
	public void modificarCategoriaProducto(String nombre) {
		Scanner scanner = new Scanner(System.in);
		...
		for (Producto producto : productos) {
			if (producto.getNombre().equalsIgnoreCase(nombre)) {
				...
				System.out.println("Categoría del producto modificada exitosamente");
				return;
			}
		}
		System.out.println("Producto no encontrado");
	...
	public void realizarCompra(Cliente cliente, Producto producto) {
